...
public class CustomerValidations {
	...
	public static Customer validateSignUp(String email, String pword, String fname, String lname, String plan,
			double regamt, String dob, Map<String,Customer> details) throws IllegalArgumentException, CustomerException {
	...
	public static void validateEmail(String email, Map<String,Customer> details) throws CustomerException {
	...
	// VALIDATE PASSWORD
	public static void validatePword(String pword, Map<String,Customer> details) throws CustomerException {
